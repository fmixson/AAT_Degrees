...
class MajorRequirements:
    ...
    def __init__(self, degree_applicable_courses, completed_ge_courses, major_requirements, major):
    ...
    def major_requirements_completed(self, major_dataframe, area_name, total_units, number_of_disciplines, number_of_courses):
        ...
        self.major_no_courses_dict[area_name]=number_of_courses

        Option = 2
        if self.major == 'English for Transfer-AAT':
        ...
        # print(self.major_no_courses_dict)
        return self.area_units_dict, self.major_course_dict, self.major_no_courses_dict
